...
public class CrmRestController {
	...
	public Mono<CustomerDocument> getCustomerByIdentity(@PathVariable String identity){
		return crmService.findCustomerById(identity); // subscribe() -> subscriber: WebFlux Library
	}
	...
	public Mono<CustomerDocument> releaseCustomer(@PathVariable String identity){
		return crmService.releaseCustomer(identity); // subscribe() -> subscriber: WebFlux Library		
	}
}
