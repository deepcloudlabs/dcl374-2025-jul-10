...
import com.example.imdb.model.Depo;
...
public class InMemoryMovieService implements MovieService {
	...
	public InMemoryMovieService(SequenceService sequenceSrv) {
		...
		System.out.println("InMemoryMovieService() instance is created!");
	...
	public void setSequenceSrv(SequenceService sequenceSrv) {
		System.out.println("setSequenceSrv(%s)".formatted(sequenceSrv.getClass().getName()));
		//this.sequenceSrv = sequenceSrv;
	}
	...
	public void populate() {
		System.out.println("sequenceSrv: %s".formatted(sequenceSrv.getClass().getName()));
